...
import (
	managerFactory "game-go/niu_niu/factory/manager"
	queueFactory "game-go/niu_niu/factory/queue"
	serviceFactory "game-go/niu_niu/factory/service"
	"game-go/shared/game"
...
func main() {
	managerMaker := managerFactory.New(1008, 50)
